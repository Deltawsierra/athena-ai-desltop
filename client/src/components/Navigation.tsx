...
import { Shield, Activity, Bug, Settings, LogOut, Users, Brain, FileText, ListChecks, FolderOpen, MessageSquare, Trash2, ChevronDown, LayoutDashboard, Link2, FileArchive, ScrollText, CircleDot } from "lucide-react";
...
const testsDropdownItems = [
  ...
  { path: "/findings", label: "Findings", icon: CircleDot },
