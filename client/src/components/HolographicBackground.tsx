...
const FloatingGeometry = ({ scrollY, mouseX, mouseY }: { scrollY: any; mouseX: number; mouseY: number }) => {
  const shapes = [
    { type: 'circle', x: 15, y: 20, size: 120, color: 'cyan', rotation: 0 },
    { type: 'polygon', x: 75, y: 35, size: 100, color: 'magenta', rotation: 0 },
    { type: 'rect', x: 45, y: 70, size: 80, color: 'purple', rotation: 45 },
    { type: 'circle', x: 85, y: 75, size: 90, color: 'cyan', rotation: 0 },
    { type: 'polygon', x: 25, y: 60, size: 70, color: 'magenta', rotation: 30 },
  ];
      ...
      <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
        ...
        {shapes.map((shape, i) => {
              ...
              <motion.g key={i}>
                <motion.circle
                  ...
                  animate={{
                    ...
                    opacity: [0.3, 0.6, 0.3],
                    x: [parallaxX, parallaxX + 10, parallaxX],
          ...
          if (shape.type === 'polygon') {
            ...
            return (
              <motion.g key={i} transform={`translate(${shape.x}%, ${shape.y}%)`}>
                <motion.polygon
                  points={points}
                  fill={`url(#${shape.color}Grad)`}
            ...
            <motion.g key={i} transform={`translate(${shape.x}%, ${shape.y}%)`}>
              <motion.rect
                ...
                animate={{
                  ...
                  scale: [1, 1.1, 1],
                  opacity: [0.3, 0.5, 0.3],
                  x: [parallaxX, parallaxX + 15, parallaxX],
